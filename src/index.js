...
const list = {
  servers: [
    ...
    "01G2XBZ9Q16KSD41RS1NTEC3Z7"
  ],
  channels: [
    "01FD5J33XHKGMJJ9XCM71B9924",
    "01GJEBEESA2S02X6CDA5PG4NC7"
  ]
};
    ...
    list.servers.forEach((e) => {
      if (m.channel.server_id === e) {
        list.channels.forEach((e) => {
          if (m.channel_id === e) {
            const content = m.content.split(' ').filter(c => c.match(/([0-9])/g)).join();
            if (content) {
